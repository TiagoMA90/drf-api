...
load_dotenv()  # This will automatically load the variables from your .env file
...
SECRET_KEY = os.getenv('SECRET_KEY')  # Use getenv to load from .env
...
DATABASES = {
    'default': ({
        ...
        os.getenv('DATABASE_URL')  # Use getenv to load the DB URL from .env
    ))
}
